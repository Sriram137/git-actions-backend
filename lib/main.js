...
function handlePushEvent(client, teamName, coreReviewers, additionalReviewers, reviewTeamSlug, fileNameMatch, needReviewOnLatestCommit) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (hasChanges) {
            const isApproved = yield checkApprovalForSHA(client, pullRequest.number, github.context.sha, coreReviewers, additionalReviewers, reviewTeamSlug, needReviewOnLatestCommit);
            if (isApproved) {
...
function checkApprovalForSHA(client, pull_number, commit_sha, coreReviewers, additionalReviewers, reviewTeamSlug, needReviewOnLatestCommit) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const requiredReviewers = [...reviewTeamMembers, ...lodash_1.default.split(coreReviewers, ','),...lodash_1.default.split(additionalReviewers, ',')];
        console.log('required reviewers');
        console.log(requiredReviewers);
        if (lodash_1.default.intersection(approvedLogins, requiredReviewers).length > 0) {
            return true;
        }
        return false;
    });
