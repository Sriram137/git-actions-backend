...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const codeOwnerMap = yield getCodeOwnersFile(client);
            const coreCOReviewers = yield getCodeOwnersReview(client, codeOwnerMap);
            if (github.context.eventName === 'push') {
                yield handlePushEvent(client, teamName, coreReviewers, coreCOReviewers, additionalReviewers, reviewTeamSlug);
                return;
            }
...
function getCodeOwnersReview(client, codeOwnerMap) {
    return __awaiter(this, void 0, void 0, function* () {
...
function getCodeOwnersFile(client) {
    return __awaiter(this, void 0, void 0, function* () {
        const coFileResponse = yield client.repos.getContents({
...
// PUSH EVENT HANDLING
function handlePushEvent(client, teamName, coreReviewers, coreCOReviewers, additionalReviewers, reviewTeamSlug) {
    return __awaiter(this, void 0, void 0, function* () {
        const pullRequest = yield getPullRequestForSHA(client, github.context.sha);
        ...
        const changedFiles = yield getChangedFiles(client, pullRequest.number);
        const hasChanges = hasReviewableChanges(changedFiles);
        if (hasChanges) {
